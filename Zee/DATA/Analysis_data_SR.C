...
void CLoop::Fill(double weight, int z_sample) {
    ...
    if(elec_medium_id && dielec && fiducial(elec_0_p4->Phi(), elec_1_p4->Phi(), elec_0_p4->Eta(), elec_1_p4->Eta(), elec_0_p4->Pt(), elec_1_p4->Pt())){
        //Filling histos
        if(elec_opposite_charge){
            if(elec_loose_iso)
                h_A->Fill(phi_star(elec_0_p4->Phi(), elec_1_p4->Phi(), elec_0_p4->Eta(), elec_1_p4->Eta()), weight);
            else
                h_B->Fill(phi_star(elec_0_p4->Phi(), elec_1_p4->Phi(), elec_0_p4->Eta(), elec_1_p4->Eta()), weight);
        }else{
            if(elec_loose_iso){
                h_C->Fill(phi_star(elec_0_p4->Phi(), elec_1_p4->Phi(), elec_0_p4->Eta(), elec_1_p4->Eta()), weight);
            }else{
                h_D->Fill(phi_star(elec_0_p4->Phi(), elec_1_p4->Phi(), elec_0_p4->Eta(), elec_1_p4->Eta()), weight);
            }
        }
    }
}
