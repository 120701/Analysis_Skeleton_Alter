...
void CLoop::Fill(double weight, int z_sample) {
    ...
    if(dimuon && muon_medium_id && fiducial(muon_0_p4->Phi(), muon_1_p4->Phi(), muon_0_p4->Eta(), muon_1_p4->Eta(), muon_0_p4->Pt(), muon_1_p4->Pt())){
        double phi_star_detector = phi_star(muon_0_p4->Phi(), muon_1_p4->Phi(), muon_0_p4->Eta(), muon_1_p4->Eta());
        if(matched){
            //decide event type
            double phi_star_truth = phi_star(muon_0_matched_p4->Phi(), muon_1_matched_p4->Phi(), muon_0_matched_p4->Eta(), muon_1_matched_p4->Eta());
